...
variable "dev_api_server_domain" {
  ...
  type        = string
  default     = "api.talktechserver.com"
}

variable "ec2_iam_role_name" {
  description = "EC2 IAM Role Name"
  type        = string
  default     = "talktech-server-ec2-role" # Add a unique name
}

variable "ec2_iam_role_policy_name" {
  description = "EC2 IAM Role Policy Name"
  type        = string
  default     = "talktech-server-ec2-role-policy" # Add a unique name
}
...
variable "code_deploy_role_name" {
  ...
  type        = string
  default     = "talktech-server-codedeploy-role" # Add a unique name
}

variable "prefix" {
  description = "Prefix to be added to AWS resources tags"
  type        = string
  default     = "talktechapp-server" # Add a unique identifier name
}

variable "project" {
  description = "Prefix to be added to AWS resources local tags"
  type        = string
  default     = "talktechapp-server" # You can use the name unique identifier created above
}
