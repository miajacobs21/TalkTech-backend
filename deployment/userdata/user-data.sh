...
git clone -b main https://github.com/miajacobs21/TalkTech-backend.git # github url
cd TalkTech-backend # project name
npm install
aws s3 sync s3://talktech-env-files/backend/production . #  s3 bucket
unzip env-file.zip
